...
animate.reveal(".home-text,.about-img,.feature-left,.social-icons,.container-social .right,.container-social.left .card-social  ", { origin: "left" });

animate.reveal(".arrow,.about-text,.services-section h2 ,.services-section h3,.feature-right ,.container-social .left,.container-social.right .card-social", { origin: "right" });

animate.reveal(".home-img,.text-center,.service-card,.feature-middle img", { interval: 150 })